Feature: Content translation special page
  ...
  Scenario: Anonymous user cannot use Content translation.
    Given I am on the content translation page in a wiki in English, translating the article "Bratislava" to Danish
  ...
  Scenario: Logged in user viewing the special page for translation.
    Given I am logged in
      And I am on the content translation page in a wiki in English, translating the article "Bratislava" to Danish
