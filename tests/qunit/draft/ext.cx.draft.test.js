...
( function ( $, mw ) {
	...
	var tests = [ {
			...
			placeholders: '<div><div id="cxmw1" class="placeholder"></div></div>',
			draft: '<p id="cxmw1">PARAGRAPH 1</p>',
			translation: '<p id="cxmw1" data-cx-draft="true">PARAGRAPH 1</p>'
		},
		{
			...
			translation: '<p id="cxmw1" data-source="1" data-cx-draft="true">PARAGRAPH 1</p>'
		},
		{
			...
			placeholders: '<div><div id="cxmw2" class="placeholder"></div><div id="cxmw3" class="placeholder"></div></div>',
			draft: '<p id="cxmw1">PARAGRAPH 1</p><p id="cxmw3">PARAGRAPH 3</p>',
			translation: '<div id="cxmw2" class="placeholder"></div><p id="cxmw1" data-cx-draft="true">PARAGRAPH 1</p><p id="cxmw3" data-cx-draft="true">PARAGRAPH 3</p>'
		},
		{
			...
			placeholders: '<div><div id="cxmw1" class="placeholder"></div><div id="cxmw2" class="placeholder"></div><div id="cxmw3" class="placeholder"></div></div>',
			draft: '<p id="cxmw2">PARAGRAPH 2</p>',
			translation: '<div id="cxmw1" class="placeholder"></div><p id="cxmw2" data-cx-draft="true">PARAGRAPH 2</p><div id="cxmw3" class="placeholder"></div>'
		},
		{
			...
			placeholders: '<div><div id="cxmw3" class="placeholder"></div><div id="cxmw2" class="placeholder"></div><div id="cxmw1" class="placeholder"></div></div>',
			draft: '<p id="cxmw1">PARAGRAPH 1</p>',
			translation: '<div id="cxmw3" class="placeholder"></div><div id="cxmw2" class="placeholder"></div><p id="cxmw1" data-cx-draft="true">PARAGRAPH 1</p>'
		},
		{
			description: 'Source article changed completely. Place the draft in linear order from the beginning of placeholders',
			source: '<div><p id="mw1">Paragraph 1</p><div><p id="mw2">Paragraph 2</p><p id="mw3">Paragraph 3</p></div>',
			placeholders: '<div><div id="cxmw1" class="placeholder"></div><div id="cxmw2" class="placeholder"></div><div id="cxmw3" class="placeholder"></div></div>',
			draft: '<p id="cxmw4">PARAGRAPH 4</p><p id="cxmw5">PARAGRAPH 5</p>',
			translation: '<p id="cxmw4" data-cx-draft="true">PARAGRAPH 4</p><p id="cxmw5" data-cx-draft="true">PARAGRAPH 5</p><div id="cxmw3" class="placeholder"></div>'
		},
		{
			...
			source: '<div><p id="mw1">Paragraph 1</p><div><p id="mw2">Paragraph 2</p><p id="mw3">Paragraph 3</p></div>',
			placeholders: '<div><div id="cxmw1" class="placeholder"></div><div id="cxmw2" class="placeholder"></div><div id="cxmw3" class="placeholder"></div></div>',
			draft: '<p id="cxmw4">PARAGRAPH 4</p><p id="cxmw5">PARAGRAPH 5</p><p id="cxmw6">PARAGRAPH 6</p><p id="cxmw7">PARAGRAPH 7</p>',
			translation: '<p id="cxmw4" data-cx-draft="true">PARAGRAPH 4</p><p id="cxmw5" data-cx-draft="true">PARAGRAPH 5</p><p id="cxmw6" data-cx-draft="true">PARAGRAPH 6</p><p id="cxmw7" data-cx-draft="true">PARAGRAPH 7</p>'
		}
	];
