...
if ( function_exists( 'wfLoadExtension' ) ) {
	...
	$wgExtensionMessagesFiles['ContentTranslationAlias'] = __DIR__ . '/ContentTranslation.alias.php';
	wfWarn(
		'Deprecated PHP entry point used for ContentTranslation extension. ' .
		'Please use wfLoadExtension instead, ' .
		'see https://www.mediawiki.org/wiki/Special:MyLanguage/Manual:Extension_registration ' .
		'for more details.'
	);
	return;
} else {
