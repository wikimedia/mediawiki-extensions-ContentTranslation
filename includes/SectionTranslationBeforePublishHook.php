...
interface SectionTranslationBeforePublishHook {
	 ...
	 *
	 * ApiSectionTranslationPublish will wait for implementations of this hook to complete before returning a response,
	 * so if the implementation needs to do something time-consuming that does not need to be sent back with the
	 * response, consider using a DeferredUpdate or Job.
	 *
