 ...
 * @param {Object} config
 */
mw.cx.ui.SentenceTranslationUnit = function SentenceTranslationUnit( translationUnitModel, view, config ) {
	// Parent constructor
	mw.cx.ui.SentenceTranslationUnit.parent.call( this, translationUnitModel, view, config );
};
